...
import { ChevronLeft, ChevronRight, Phone, ArrowRight, Pause, Play } from "lucide-react"
...
const workSections: WorkSection[] = [
  ...
  },
  {
    ...
    slides: [
      { id: "snipA", title: "Garden Path Lighting", image: "/work/landscape/snipA.jpg", alt: "Garden path lighting" },
      {
        id: "snipB",
        title: "Architectural Uplighting",
        image: "/work/landscape/snipB.jpg",
        alt: "Architectural uplighting",
      },
      { id: "snipC", title: "Tree Accent Lighting", image: "/work/landscape/snipC.jpg", alt: "Tree accent lighting" },
      {
        id: "snipD",
        title: "Patio Entertainment",
        image: "/work/landscape/snipD.jpg",
        alt: "Patio entertainment lighting",
      },
      {
        id: "snipE",
        title: "Security Perimeter",
        image: "/work/landscape/snipE.jpg",
        alt: "Security perimeter lighting",
      },
    ],
  },
  {
    ...
    slides: [
      { id: "pic1", title: "Pool Equipment Wiring", image: "/work/pool-sauna/pic1.jpg", alt: "Pool equipment wiring" },
      {
        id: "pic2",
        title: "Underwater Pool Lighting",
        image: "/work/pool-sauna/pic2.jpg",
        alt: "Underwater pool lighting",
      },
      {
        id: "pic3",
        title: "Sauna Electrical Setup",
        image: "/work/pool-sauna/pic3.jpg",
        alt: "Sauna electrical installation",
      },
      {
        id: "pic4",
        title: "Hot Tub Electrical",
        image: "/work/pool-sauna/pic4.jpg",
        alt: "Hot tub electrical connection",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    slides: [
      { id: "pic1", title: "Main Panel Upgrade", image: "/work/panels/pic1.jpg", alt: "Main electrical panel upgrade" },
      { id: "pic2", title: "Sub-Panel Installation", image: "/work/panels/pic2.jpg", alt: "Sub-panel installation" },
      { id: "pic3", title: "Circuit Breaker Upgrade", image: "/work/panels/pic3.jpg", alt: "Circuit breaker upgrade" },
      { id: "pic4", title: "Surge Protection", image: "/work/panels/pic4.jpg", alt: "Surge protection installation" },
    ],
  },
  {
    id: "accent-specialty",
    ...
    slides: [
      { id: "slideA", title: "LED Strip Accent", image: "/work/accent/slideA.jpg", alt: "LED strip accent lighting" },
      {
        id: "slideB",
        title: "Architectural Features",
        image: "/work/accent/slideB.jpg",
        alt: "Architectural feature lighting",
      },
    ],
  },
]
...
function useSwipeable(handlers: { onSwipedLeft: () => void; onSwipedRight: () => void }) {
...
const Slideshow = React.memo<{ section: WorkSection }>(({ section }) => {
  const { currentSlide, isAutoPlaying, isLoading, setIsLoading, nextSlide, prevSlide, goToSlide, toggleAutoplay } =
  ...
  return (
    ...
    >
      ...
      <header className="bg-black px-6 py-4">
        <h3 className="text-white font-bold text-xl text-center tracking-wide">{section.title}</h3>
      </header>
        ...
        <div className="relative w-full h-full">
          ...
          {section.slides.length > 1 && (
            <div className="hidden">
              <Image
                src={nextSlideData.image || "/placeholder.svg?height=400&width=400"}
                ...
                {section.slides.map((slide, index) => (
                  <button
                    ...
                    className={`transition-all duration-300 rounded-full focus:outline-none focus:ring-2 focus:ring-red-400 ${
                      index === currentSlide ? "bg-red-600 w-6 h-2" : "bg-white/60 hover:bg-white/80 w-2 h-2"
                    }`}
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 z-30">
            <h4 className="text-white text-lg font-semibold drop-shadow-lg">{currentSlideData?.title}</h4>
          </div>
        </div>
      </div>
    </article>
  ...
  const slideshowGrid = useMemo(
    () =>
      workSections.map((section) => (
        <div key={section.id} className="transform hover:scale-[1.02] transition-transform duration-300">
    ...
    <section className="bg-white py-20" aria-labelledby="our-work-heading">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <header className="text-center mb-16">
          <h1 id="our-work-heading" className="text-5xl md:text-6xl font-bold text-black mb-4 tracking-tight">
            Our Work
          </h1>
          <div className="w-24 h-1 bg-red-600 mx-auto mb-6" aria-hidden="true" />
          <h2 className="text-2xl md:text-3xl text-red-600 font-bold mb-8">Powering Long Island Homes & Businesses</h2>
          <p className="text-gray-700 text-lg md:text-xl max-w-4xl mx-auto leading-relaxed">
            Explore our portfolio of professional electrical installations across Nassau and Suffolk County. From custom
            lighting solutions to complete electrical system upgrades, see the quality craftsmanship that sets CRC
            Electric apart.
          </p>
        </header>
